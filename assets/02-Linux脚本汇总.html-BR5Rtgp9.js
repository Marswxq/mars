import{_ as n,c as a,d as e,o as l}from"./app-DIaWKDqb.js";const p={};function i(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="linux-脚本汇总" tabindex="-1"><a class="header-anchor" href="#linux-脚本汇总"><span>Linux 脚本汇总</span></a></h1><h2 id="比较ab两台服务器文件是否一致" tabindex="-1"><a class="header-anchor" href="#比较ab两台服务器文件是否一致"><span>比较AB两台服务器文件是否一致</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token shebang important">#!/bin/bash</span></span>
